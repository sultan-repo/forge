...
for item in SKILL.md README.md BOOTSTRAP.md CHANGELOG.md VERSION LICENSE references templates evals scripts docs; do
...
if command -v python3 >/dev/null 2>&1; then
  ...
  echo "Forge installed at $DEST_DIR (Python validator unavailable)." >&2
fi
